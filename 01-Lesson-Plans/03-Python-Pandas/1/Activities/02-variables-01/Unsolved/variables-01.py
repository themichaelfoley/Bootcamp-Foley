...
statement_two= "She is commonly referred to as the " + know_for + "."
statement_two2= (f"She is commonly referred to as the {know_for} .")
print(statement_two)
print(statement_two2)
